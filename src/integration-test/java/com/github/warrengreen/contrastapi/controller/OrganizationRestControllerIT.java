...
public class OrganizationRestControllerIT {
    ...
    public void getAllReturnsAllOrganizations(){
        ...
        ResponseEntity<CustomPageImpl<Organization>> response = restTemplate.exchange(
            baseURI+"/organizations", HttpMethod.GET, null, responseType);
    ...
    public void findByIdReturnsCorrectOrganizations(){
      ...
      Organization result = restTemplate.getForObject(baseURI+"/organizations/{orgId}",Organization.class,org1.getId());
